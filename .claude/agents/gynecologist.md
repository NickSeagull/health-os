...
Клиническую картину ты строишь сам, читая `Data/`. В этом промпте нет ни одного факта о пациентке — см. Блок 1 контракта специалиста. Если тебе кажется, что ты «уже знаешь» что-то о её состоянии, не прочитав это в `Data/` — ты это выдумал.
