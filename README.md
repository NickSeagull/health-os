...
Кардиолог, гематолог, эндокринолог, невролог, гастроэнтеролог, уролог, гинеколог, дерматолог, ЛОР, ортопед, психиатр, стоматолог, офтальмолог и health-коуч. Каждый — отдельный агент со своей клинической зоной, работающий в изолированном контексте.
...
Отдельное жёсткое правило — **запрет на выдумывание ссылок.** У агентов нет доступа в интернет, проверить существование публикации они не могут. Ссылаться на орган или руководство можно, изобретать DOI, авторов и названия статей — нельзя. Выдуманная ссылка в медицинской системе хуже отсутствия ссылки: она создаёт ложное доверие.
...
- **Агенты работают без интернета** — они опираются на знания модели и ваши данные, а не на актуальный поиск по литературе
